...
export default function Kolam() {
  ...
  // useEffect - Mengubah judul halaman saat komponen dimuat.
  useEffect(() => {
    document.title = "Floody - Report";
  }, []);

  // State currentDateTime - Menyimpan waktu dan tanggal saat ini.
  const [currentDateTime, setCurrentDateTime] = useState('');

  // useEffect - Mengupdate waktu secara berkala setiap detik.
  useEffect(() => {
  ...
  // Render - Mengembalikan tampilan halaman Machine Learning.
  return (
