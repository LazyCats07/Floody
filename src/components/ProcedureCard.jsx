    ...
    >
      <CardContent>
        <span style={{ display: 'flex', alignItems: 'center' }}>
          <img src={processImage} alt="icon" style={{ width: '70px', margin: '-5px 10px 10px 0' }} />
          <b style={{ fontSize: '30px', marginTop: '5px', marginLeft: '10px' }}>
            Prosedur Operasi Pintu Air dan Pompa
          </b>
        </span>
            ...
            <TableHead>
              <TableRow>
                <TableCell sx={{ fontSize: '18px' }}>
                  <b>Pintu Air (Tinggi Dalam Polder)</b>
                </TableCell>
                <TableCell sx={{ fontSize: '18px' }}>
                  <b>Pompa (Tinggi Dalam Polder)</b>
                </TableCell>
                <TableCell sx={{ fontSize: '18px' }}>
                  <b>Sungai Citarum</b>
                </TableCell>
            ...
            <TableBody>
              <TableRow>
                <TableCell sx={{ wordBreak: 'break-word', fontSize: '16px' }}>
                  <div>Elevasi Tutup Pintu: <b>+8.0 cm</b></div>
                  <div>Elevasi Buka Pintu: <b>+6.0 cm</b></div>
                </TableCell>
                <TableCell sx={{ wordBreak: 'break-word', fontSize: '16px' }}>
        ...
        <div className="kapasitas-info">
          <blockquote>
            <p style={{ fontSize: '18px', marginTop: '-10px', textAlign: 'justify' }}>
              Diperoleh dari berbagai sumber yang kebenarannya (data definitif)
              <b> Perlu</b> dipastikan atau disepakati bersama, <b> terutama </b> data luas daerah layanan
              (DTA = Daerah Tangkapan Air) dan luas kolam retensi yang sangat menentukan beban debit banjir dan
              <b> kebutuhan pompa berikut pola operasinya.</b>
            </p>
          </blockquote>
        </div>
      </CardContent>
