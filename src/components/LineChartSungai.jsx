...
const LineChartSungai = () => {
  const [data, setData] = useState([]);
  const [labels, setLabels] = useState([]);

  // Fetch data from Firebase Realtime Database
  useEffect(() => {
    const dbRef = ref(database, "Polder/TMA_Sungai"); // Path yang sesuai dengan data Anda di Realtime Database
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: 'Tinggi Air Sungai Citarum',  // Replace this with your dataset name
        data: data,
        fill: false,
...
export default LineChartSungai;
